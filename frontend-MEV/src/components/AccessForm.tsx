  ...
  return (
    <section id="access" className="relative py-32 px-6">
      ...
      <div className="relative max-w-xl mx-auto">
        ...
        {/* SUCCESS STATE */}
        {status === "success" ? (
          <div className="intel-panel-glow p-10 text-center space-y-4">
            <p className="data-label">// Request Received</p>
            <h3 className="text-xl font-semibold text-foreground">
              Access Request Submitted
            </h3>
            <p className="text-muted-foreground text-sm max-w-sm mx-auto">
              Thanks for your interest in INTELLEUM.
              <br />
              We review every request manually and will reach out if it’s a fit.
            </p>
          </div>
        ) : (
          <form
            onSubmit={handleSubmit}
            className="intel-panel-glow p-8 space-y-6"
          >
            <div className="space-y-2">
              <label className="data-label">Name</label>
              <Input
