...
const audiences = [
  {
    ...
    description: "See when user flow is getting extracted and which pools or routes need protection first.",
    icon: "◈",
  },
  {
    title: "Liquidity Providers & Vaults",
    description: "Identify toxic pools, repeat extractors, and adverse flow before it compounds into LP loss.",
    icon: "◇",
  },
  {
    title: "Validators & Infra-Operators",
    description: "Monitor MEV-heavy execution landing patterns and understand your validator-side orderflow context.",
    icon: "⬡",
  },
  {
    title: "Researchers, Funds & Risk Teams",
    description: "Study live Solana MEV behavior, wallet-level operators, and evolving market structure with evidence.",
    icon: "△",
  },
];
