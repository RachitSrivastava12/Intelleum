...
const steps = [
  ...
  {
    number: "03",
    title: "Operator Profiling",
    description:
      "Builds wallet-level operator profiles from repeated execution shape, fee aggression, routing behavior, and pool concentration, then expands into richer entity mapping as more history accumulates.",
      icon: "◇",
  },
  {
    number: "04",
    ...
    description:
      "Identifies sandwich, arbitrage, JIT liquidity, liquidation, and suspicious orderflow patterns from reconstructed swap windows and token-balance movement.",
       icon: "△",
  },
  {
    number: "05",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="mt-2 text-muted-foreground text-sm max-w-2xl">
            We turn raw Solana block flow into live detections, operator profiles, and market-structure intelligence.
          </p>
        </motion.div>
