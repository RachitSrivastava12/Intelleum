      ...
      <div className="max-w-6xl mx-auto space-y-16">
        ...
        <div className="intel-panel p-8 border-l-4 border-yellow-500">
          ...
          <p className="text-lg leading-relaxed">
            This analysis covers <b>16 Solana slots </b>.
          ...
          <p className="mt-3 text-sm text-muted-foreground">
            We identify <b>MEV operators and emerging entities</b>.
            Many profiles begin as a single high-signal wallet and expand as more coordinated history is observed.
          </p>
        </div>

        {/* ===================== ENTITY FORENSICS ===================== */}
        <div>
          <h2 className="text-2xl font-semibold mb-6">MEV Operators & Entities</h2>
